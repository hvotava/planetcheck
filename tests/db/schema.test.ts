...
describe("migrations", () => {
  it("apply in order, exactly once", async () => {
    ...
    expect(first.applied).toEqual(["0001_init.sql", "0002_schema_additions.sql", "0003_api_functions.sql", "0004_prophecies.sql", "0005_school_mode.sql", "0006_newsletter.sql"]);
